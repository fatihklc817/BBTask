...
ABBTaskCharacter::ABBTaskCharacter()
{
...
void ABBTaskCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ABBTaskCharacter::Move);
...
void ABBTaskCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ABBTaskCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
